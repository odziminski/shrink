    ...
    <body>
        <div class="content container text-center">
            ...
            <form action="/shorten" method="POST">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="urlInput" name="original_link" class="form-control w-50 p-3 container d-inline-block" placeholder="paste your link to shorten" />
            ...
            <div class="input-group card-body w-25 p-3 container">
                <input type="text" value="{{$short_link}}" id="output" class="form-control-plaintext w-25 p-3 border" />
                <button onclick="copyToClipboard()" class="btn btn-primary border">
